...
package uk.gov.hmrc.customs.hodsproxy

// TODO replace whole application logger with instances for specific classes
object Logger {
  lazy val logger                          = play.api.Logger("eori-common-component-hods-proxy")
