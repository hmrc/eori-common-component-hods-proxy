...
class CdsMetrics @Inject() (metrics: MetricRegistry) {
  ...
  val timers = Map(
    ...
    MetricsEnum.VAT_KNOWN_FACTS_CONTROL_LIST -> metrics.timer(
  ...
  val successCounters = Map(
    ...
    MetricsEnum.SUBSCRIPTION_DISPLAY -> metrics.counter(
      "messaging-subscription-display-success-counter"
    ),
    MetricsEnum.REGISTRATION_DISPLAY -> metrics.counter(
    ...
    MetricsEnum.UPDATE_VERIFIED_EMAIL -> metrics.counter(
  ...
  val failedCounters = Map(
    ...
    MetricsEnum.REGISTER_WITH_EORI_AND_ID -> metrics.counter(
